...
int main()
{
	...
	//test
	LPVOID test1 = VirtualAlloc(nullptr, 0x100, MEM_RESERVE | MEM_COMMIT, PAGE_EXECUTE_READWRITE);
	LPVOID test2 = VirtualAlloc(nullptr, 0x200, MEM_RESERVE | MEM_COMMIT, PAGE_EXECUTE_READWRITE);
	system("pause");
}